...
/* site/map.html.twig */
class __TwigTemplate_a0669abdbcd0333ec0076696120b43ac extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row\">
            <div class=\"col-lg-6\">
                <p>
                    ...
                    auch Juden und Jüdinnen, die zuvor in Vernichtungslager verschleppt
...
";
    ...
    {
        return array (  392 => 258,  386 => 255,  382 => 254,  376 => 251,  354 => 234,  349 => 232,  343 => 231,  317 => 220,  307 => 213,  298 => 207,  293 => 204,  95 => 7,  92 => 6,  82 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    <script>
        ...
        const HelmstedtBeendorfFrauen = L.marker([52.23989233360328, 11.089496406413582], {icon: isInDataIcon}).bindPopup('<strong>Helmstedt-Beendorf (Frauen)</strong><br/>');
        const HHDessauerUfer = L.marker([53.525, 10.010556], {icon: isStudyIcon}).bindPopup('<strong>Hamburg-Dessauer Ufer</strong><p>Das Außenlager des KZ Neuengamme war im September 1944 eingerichtet worden. Die etwa 500  Häftlinge waren zuvor im Außenlager Wedel inhaftiert und mussten insbesondere Zwangsarbeit beim Bau von Behelfswohnheimen leisten. Anfang April 1945 wurden die Häftlinge nach Bergen-Belsen deportiert.</p>&#9656; <a href=\"{{ path('app_map') }}#dessauerUferMore\">Mehr zu Hamburg-Dessauer Ufer</a><br/>&#9656; <a href=\"{{ path('app_deportation_dessauerUfer') }}\">Fallstudie Dessauer Ufer</a>');
        const HHEidelstedt = L.marker([53.60677, 9.87835], {icon: isStudyIcon}).bindPopup('<strong>Hamburg-Eidelstedt</strong><p>Am 27. September 1944 wurden etwa 500 ungarische und tschechische Jüdinnen, die zuvor am Dessauer Ufer und in Wedel inhaftiert waren, in das Außenlager Eidelstedt des KZ Neuengamme deportiert. Hier mussten sie Zwangsarbeit beim Bau von Behelfswohnheimen für die Hamburger Zivilbevölkerung und bei Trümmer- und Schneeräumungen im Stadtgebiet leisten. Anfang April 1945 wurden in Erwartung der baldigen Befreiung Hamburgs die Hamburger Außenlager geräumt und die Häftlinge aus dem Stadtgebiet deportiert. Die Häftlinge des Außenlagers Eidelstedt wurden nach Bergen-Belsen deportiert, wo viele von ihnen starben.</p>&#9656; <a href=\"eidelstedtMore\">Mehr zu Hamburg-Eidelstedt</a>');
        const HHHammerbrook = L.marker([53.55075, 10.022389], {icon: isInDataIcon}).bindPopup('<strong>Hamburg-Hammerbrook (Spaldingstraße)</strong><br/>');
        const HHLangenhorn = L.marker([53.672192, 9.99293], {icon: isInDataIcon}).bindPopup('<strong>Hamburg-Langenhorn</strong><br/>');
        const HHNeugraben = L.marker([53.460985, 9.868133], {icon: isInDataIcon}).bindPopup('<strong>Hamburg-Neugraben</strong><br/>');
        ...
        const VWWerkHalle1 = L.marker([52.4275, 10.7922], {icon: isStudyIcon}).bindPopup('<strong>VW-Werk Halle 1</strong><p>Neben bereits bestehenden Konzentrations- und anderen Zwangsarbeitslagern waren im Juni 1944 300 jüdische KZ-Häftlinge direkt im VW-Werk untergebracht. Sie sollten die Kernbelegschaft für eine unterirdische Raketenproduktion bilden und im VW-Werk ausgebildet werden. Nach der Bombardierung des Werkes Ende Juni wurden die Häftlinge ins Außenlager Thil des KZ Natzweiler in Frankreich deportiert.</p>&#9656; <a href=\"#vwWerkMore\">Mehr zu VW-Werk Halle1</a></br>&#9656; <a href=\"{{ path('app_deportation_vw') }}\">Fallstudie 300er-Gruppe</a>');
        const WatensteidtLeindeMen = L.marker([52.137516462553755, 10.436547953373374], {icon: isInDataIcon}).bindPopup('<strong>Salzgitter-Watenstedt/Leinde (Männer)</strong><br/>');
        const WatensteidtLeindeFrauen = L.marker([52.13748315467425, 10.43655563535315], {icon: isInDataIcon}).bindPopup('<strong>Salzgitter-Watenstedt/Leinde (Frauen)</strong><br/>');
